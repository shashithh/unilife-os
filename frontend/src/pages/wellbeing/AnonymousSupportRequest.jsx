...
export function AnonymousSupportRequest() {
  ...
  const handleMessageChange = (e) => {
    ...
    if (value.length > 50) {
      setMessageError("Description must be 50 characters or less");
    } else {
      setMessageError("");
    }
  };
  ...
  if (isSuccess) {
    return (
      <div className="max-w-2xl mx-auto mt-12 animate-fade-in">
        <Card className="text-center py-12 border-indigo-100 bg-indigo-50/30">
      ...
      <div className="flex items-start gap-4 p-5 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 rounded-2xl">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <Badge variant="purple">100% Anonymous</Badge>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-1.5">
              ...
              >
                ...
                <option value="academic">Academic Pressure / Overwhelm</option>
                <option value="mental">Mental Health Concern</option>
            ...
            <div>
              ...
              <div className="flex justify-between mt-1">
                {messageError ? (
                  <p className="text-xs text-rose-500">{messageError}</p>
                ) : (
                  <p className="text-xs text-slate-400">Maximum 50 characters.</p>
                )}
                <p className="text-xs text-slate-400">{message.length}/50</p>
              </div>
            </div>
            ...
            <div className="bg-rose-50 p-4 rounded-xl border border-rose-100 flex items-start gap-3">
              ...
              <div className="text-sm text-rose-800">
                <p className="font-semibold mb-1">Immediate Danger?</p>
                <p>
            ...
            <Button
              ...
              fullWidth
              size="lg"
              disabled={!topic || !message || message.length > 50 || isSubmitting}
              className="bg-slate-800 hover:bg-slate-900 focus:ring-slate-800"
            >
              {isSubmitting ? "Encrypting & Sending..." : "Submit Anonymously"}
            </Button>
          </form>
        </CardContent>
      </Card>
