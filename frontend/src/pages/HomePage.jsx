      ...
      <header className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 text-center relative z-10">
          ...
          <p className="max-w-2xl mx-auto text-lg lg:text-xl text-slate-600 mb-10 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            UniLife OS is your intelligent campus companion. Seamlessly connect academics, wellbeing, collaboration, and productivity in one beautiful platform.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "Seamlessly organize team projects, share files, and communicate with your peers.",
      ...
      <section className="py-20 lg:py-32 bg-white text-center relative overflow-hidden text-slate-800">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          ...
          <p className="text-lg text-slate-600 mb-10">
            Join thousands of students who are already using UniLife OS to manage their tasks, collaborate with peers, and maintain their mental wellbeing.
          </p>
          <Button
            variant="primary"
            size="lg"
